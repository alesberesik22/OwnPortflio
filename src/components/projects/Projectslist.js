...
import kanbanBoardImage from '../../assets/images/kanbanBoard.png'
import kanbanBoardVideo from '../../assets/videos/kanban_board.mp4'
...
const projectList = [
    ...
    },
    {
        ...
        title: "Kanban board",
        github: "https://github.com/alesberesik22/kanban_board_react",
        demo: "https://github.com/alesberesik22/Kanban_board",
        video: kanbanBoardVideo,
        tag: "React JS, Typescript, Material UI, Redux toolkit, React DnD, React Router Dom, Java, Spring Boot, PostgreSQL, Docker",
        description:
            "Kanban board application used manage tasks within columns. " +
            "User is able to create delete and edit board. In the board it " +
            "is possible to create new columns edit them or delete. To each " +
            "column it is possible to add tasks with description and priority. " +
            "Tasks can be dragged and dropped within the columns",
    },
];
